...
class ProductUpdateRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'active.integer' => __('products.validation.active_required'),

            'categoryIds.required' => __('products.validation.product_category_required'),

            'nameHy.required' => __('products.validation.title_hy_required'),
            'nameEn.required' => __('products.validation.title_en_required'),
            'nameRu.required' => __('products.validation.title_ru_required'),
