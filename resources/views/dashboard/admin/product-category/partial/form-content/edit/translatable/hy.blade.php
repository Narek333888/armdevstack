        ...
        <div class="bg-light_ rounded h-100">
            <div class="form-floating mb-3">
                <input type="text"
                       ...
                       autocomplete="off"
                       value="{{ $productCategory->productCategoryText->getTranslation('name', 'hy') ?? old('nameHy') }}"
                >
            ...
            <div class="form-floating mb-3">
                <input type="text"
                       ...
                       name="seoUrlHy"
                       id="seoUrlHy"
                       placeholder="{{ __('product-categories.edit.seo_url_hy_input_placeholder') }}"
                       autocomplete="off"
                       value="{{ $productCategory->productCategoryText->getTranslation('seo_url', 'hy') ?? old('seoUrlHy') }}"
                >
                <label for="seoUrlHy">{{ __('product-categories.edit.seo_url_hy_input_label') }}</label>
            ...
            <div class="form-floating">
                <textarea
                    ...
                    name="descriptionHy"
                    id="descriptionHy"
                    style="height: 150px;">{{ $productCategory->productCategoryText->getTranslation('description', 'hy') ?? old('descriptionHy') }}</textarea>
