        ...
        <div class="bg-light_ rounded h-100">
            <div class="form-floating mb-3">
                <input type="text"
                       ...
                       name="nameHy"
                       id="nameHy"
                       placeholder="{{ __('post-categories.create.name_hy_input_placeholder') }}"
                       autocomplete="off"
                       value="{{ old('nameHy') }}"
                >
                <label for="nameHy">{{ __('post-categories.create.name_hy_input_label') }}</label>
            ...
            <div class="form-floating">
                ...
                <label for="descriptionHy">{{ __('post-categories.create.description_hy_input_label') }}</label>
