        ...
        <div class="bg-light_ rounded h-100">
            <div class="form-floating mb-3">
                <input type="text"
                       ...
                       name="nameRu"
                       id="nameRu"
                       placeholder="{{ __('post-categories.create.name_ru_input_placeholder') }}"
                       autocomplete="off"
                       value="{{ old('nameRu') }}"
                >
                <label for="nameRu">{{ __('post-categories.create.name_ru_input_label') }}</label>
            ...
            <div class="form-floating">
                ...
                <label for="descriptionRu">{{ __('post-categories.create.description_ru_input_label') }}</label>
