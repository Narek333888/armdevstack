        ...
        <div class="bg-light_ rounded h-100">
            <div class="form-floating mb-3">
                <input type="text"
                       ...
                       name="nameEn"
                       id="nameEn"
                       placeholder="{{ __('products.create.name_en_input_placeholder') }}"
                       autocomplete="off"
                       value="{{ old('nameEn') }}"
                >
                <label for="nameHy">{{ __('products.create.name_en_input_label') }}</label>
            ...
            <div class="form-floating mb-3">
                ...
                <label for="shortDescriptionEn">{{ __('products.create.short_description_en_input_label') }}</label>
            ...
            <label>{{ __('products.create.description_en_input_label') }}</label>
            <div class="form-floating">
                ...
                <label for="descriptionEn">{{ __('products.create.description_en_input_label') }}</label>
