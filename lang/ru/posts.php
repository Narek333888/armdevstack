...
return [
    ...
    'alert' => [
        ...
        'please_select_at_least_one_post_to_delete' => 'Выберите хотя бы один пост для удаления.',
    ...
    'edit' => [
        'title_hy_input_label' => 'Название на армянском',
        'title_en_input_label' => 'Название на английском',
        'title_ru_input_label' => 'Название на русском',
        ...
        'title_hy_input_placeholder' => 'Название на армянском',
        'title_en_input_placeholder' => 'Название на английском',
        'title_ru_input_placeholder' => 'Название на русском',
